...
export class KVDAO {
    ...
    async getProfessor(id: string): Promise<ProfessorDTO> {
        ...
        return plainToInstance(ProfessorDTO, JSON.parse(profString));
    ...
    async getPendingReview(id: string): Promise<PendingReviewDTO> {
        ...
        return transformAndValidate(PendingReviewDTO, JSON.parse(pendingRatingString));
    }
    ...
    async getUser(username: string): Promise<User> {
        ...
        return transformAndValidate(User, JSON.parse(userString));
    }
    ...
    async getPendingProfessor(id: string): Promise<ProfessorDTO> {
        ...
        return transformAndValidate(ProfessorDTO, JSON.parse(pendingProfessorString));
    }
