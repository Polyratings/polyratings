    ...
    return (
        ...
        >
            ...
            <AnimateHeight
                ...
                className="absolute left-0 top-12 z-50 w-full -translate-y-1 transform bg-cal-poly-green"
            >
                <button
            ...
            <div className="hidden items-center text-lg font-semibold text-white md:flex">
                ...
                <a href="https://github.com/Polyratings/polyratings" target="_blank" rel="noreferrer">
                    <img
                        src={GithubLogo}
                        alt="Github Link"
