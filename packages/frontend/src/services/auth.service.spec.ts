...
const mockToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyNSIsImVtYWlsIjoibWZpc2hlMTNAY2FscG9seS5lZHUiLCJpYXQiOjE1MTYyMzkwMjJ9.b45hRUjEOUSHaOUHb6yQiF5LwMmsA-GQs6Rm3-vFRu4'
...
describe('Auth Service', () => {
    ...
    it('emit\'s events correctly', async () => {
        ...
        const subscription = authService.isAuthenticatedSubject.subscribe((authState) => authStates.push(authState));
        fetchFunction = () => {
            const res:JwtAuthResponse = {
                accessToken:mockToken
            }
