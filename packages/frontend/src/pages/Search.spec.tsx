...
import { injector, Logger, TeacherService } from "@/services";
...
describe("<Search />", () => {
    ...
    it("Restores search value state", async () => {
        ...
        const teacherCard = await documentBody.findByText(
            `${firstTeacher.lastName}, ${firstTeacher.firstName}`,
        );
    ...
    it("Handles failure appropriately", async () => {
        ...
        expect(errorLog).toBeGreaterThan(0);
