...
export function Teacher() {
    ...
    function ClassScroll({ outerClassName, innerClassName }: {outerClassName:string, innerClassName:string}) {
  return (
...
function ClassSection({ reviews, taughtClass }:{reviews:ReviewEntry[], taughtClass:string}) {
    ...
    const unexpandedPreviewHeight = (reviews:ReviewEntry[]) => (reviews.length > UNEXPANDED_LIMIT ? 25 : 0);
