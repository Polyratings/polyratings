...
describe("intersectingDbEntities", () => {
    ...
    test("Finds no intersections on non overlapping array", () => {
        const arr1 = [1, 2, 3].map(createDbEntity);
    ...
    test("Finds intersections on more than two arrays", () => {
        const arr1 = [1, 2, 3].map(createDbEntity);
